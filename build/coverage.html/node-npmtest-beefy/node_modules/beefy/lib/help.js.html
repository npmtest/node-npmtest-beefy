...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-beefy/node_modules/beefy/lib/help.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-beefy/node_modules/beefy/lib/help.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-beefy/node_modules/beefy/lib/</a> &#187; help.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function help(io) {</span>
/*
...
*/
&nbsp;
<span class="cstat-no" title="statement not covered" >  var str = help + ''</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  io.error(str.slice(str.indexOf('/*') + 3, str.indexOf('*/')))</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
